    ...
    <div className="mx-auto max-w-6xl px-4 pb-16 pt-10">
      <section className="grid gap-8 rounded-[36px] border border-sand-200 bg-white p-8 shadow-soft md:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button variant="ghost">Kampanyalari gor</Button>
          </div>
        </div>
      ...
      <section className="mt-12">
        <SectionHeader
          ...
          action={<Button variant="ghost">Tum kategoriler</Button>}
        />
      ...
      <section className="mt-12">
        <SectionHeader
          ...
          action={<Button variant="dark">Tum urunler</Button>}
        />
      ...
      <section className="mt-12 grid gap-6 md:grid-cols-2">
        <div className="rounded-3xl border border-sand-200 bg-brand-500 p-8 text-white">
          ...
          <Button className="mt-6 bg-white text-brand-600 hover:bg-white/90">Incele</Button>
        </div>
        <div className="rounded-3xl border border-sand-200 bg-white p-8">
          ...
          <Button variant="ghost" className="mt-6">Kesfet</Button>
        </div>
      </section>
    </div>
  );
